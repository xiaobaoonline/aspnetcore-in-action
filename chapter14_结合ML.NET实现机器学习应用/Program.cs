...
namespace ONNX_Sample
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var modelFilePath = Path.Combine(assetsPath, "Model", "resnet50-v1-7.onnx");
            ...
            try
            {
                ...
                foreach (var probable in probabilities)
                {
                    ...
                    var (topResultIndex, topResultScore) = scores.Select((predictedClass, index) => (Index: index, Value: predictedClass))
                        ...
                        .First();
                    Console.WriteLine("图片：{0} \r\n分类{1} {2}：{3}",
                        Path.GetFileName(images.ElementAt(index).ImagePath),
                        topResultIndex,
                        categoryLabels[topResultIndex],
                        topResultScore);
                    Console.WriteLine("=============================");
                    index++;
                }
        ...
        private static string[] categoryLabels = new string[]
        {
            "tench, Tinca tinca",
